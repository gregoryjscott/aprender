...
function askQuestion() {
  ...
  console.log(
    `Conjugate "${verb.spanish}" for "${pronoun.spanish}" in imperfect tense.`
  )
}
...
function determineCorrectAnswer() {
  ...
  if (verb.spanish.endsWith('ar')) {
    switch (pronoun.spanish) {
      ...
      case 'Nosotras':
        return (
          (verb.imperfect && verb.imperfect.nosotrosNosotras) ||
          `${start}ábamos`
        )
      case 'Ellos':
      case 'Ellas':
      case 'Ustedes':
        return (
          (verb.imperfect && verb.imperfect.ellosEllasUstedes) || `${start}aban`
        )
      default:
        oops()
    }
    ...
    switch (pronoun.spanish) {
      ...
      case 'Nosotras':
        return (
          (verb.imperfect && verb.imperfect.nosotrosNosotras) || `${start}íamos`
        )
      case 'Ellos':
      case 'Ellas':
      case 'Ustedes':
        return (
          (verb.imperfect && verb.imperfect.ellosEllasUstedes) || `${start}ían`
        )
      default:
        oops()
    }
