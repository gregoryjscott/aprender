...
function askQuestion() {
  ...
  console.log(
    `Conjugate "${verb.spanish}" for "${pronoun.spanish}" in preterit tense.`
  )
}
  ...
  if (verb.spanish.endsWith('ar')) {
    switch (pronoun.spanish) {
      ...
      case 'Nosotras':
        console.log('wat?')
        return (
          (verb.preterit && verb.preterit.nosotrosNosotras) || `${start}amos`
        )
      case 'Ellos':
      case 'Ellas':
      case 'Ustedes':
        return (
          (verb.preterit && verb.preterit.ellosEllasUstedes) || `${start}aron`
        )
      default:
        oops()
    }
    ...
    switch (pronoun.spanish) {
      ...
      case 'Nosotras':
        return (
          (verb.preterit && verb.preterit.nosotrosNosotras) || `${start}ímos`
        )
      case 'Ellos':
      case 'Ellas':
      case 'Ustedes':
        return (
          (verb.preterit && verb.preterit.ellosEllasUstedes) || `${start}ieron`
        )
      default:
        oops()
    }
